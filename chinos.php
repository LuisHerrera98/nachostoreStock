...
<body>
    ...
    <section>
    <h2 class="productosDestacados" style="margin:0; text-align:center;margin-top:12px; margin-bottom:12px ;font-size:18px;">Chinos</h2>
        ...
        <div class="caja-talles">
            <div class="caja-talle">
                <a href="chinosLista.php?talle=38" style="color:#333;" type="submit"><i class="fas fa-folder icono-carpeta"><p class="texto-talle">TALLE 38</p></i></a>
            </div>
            <div class="caja-talle">
                <a href="chinosLista.php?talle=40"style="color:#333;" type="submit"><i class="fas fa-folder icono-carpeta"><p class="texto-talle M">TALLE 40</p></i></a>
            </div>
            <div class="caja-talle">
                <a href="chinosLista.php?talle=42"style="color:#333;" type="submit"><i class="fas fa-folder icono-carpeta"><p class="texto-talle L">TALLE 42</p></i></a>
            </div>
            <div class="caja-talle">
                <a href="chinosLista.php?talle=44"style="color:#333;" type="submit"><i class="fas fa-folder icono-carpeta"><p class="texto-talle XL">TALLE 44</p></i></a>
            </div>
            <div class="caja-talle">
                <a href="chinosLista.php?talle=46"style="color:#333;" type="submit"><i class="fas fa-folder icono-carpeta"><p class="texto-talle XXL">TALLE 46</p></i></a>
            </div>
            <div class="caja-talle">
                <a href="chinosLista.php?talle=48"style="color:#333;" type="submit"><i class="fas fa-folder icono-carpeta"><p class="texto-talle XXXL">TALLE 48</p></i></a>   
            </div>
            <div class="caja-talle">
                <a href="chinosLista.php?talle=50"style="color:#333;" type="submit"><i class="fas fa-folder icono-carpeta"><p class="texto-talle XXXL">TALLE 50</p></i></a>   
            </div>
        </div>
    </section>
    <footer>
