...
<body>
    ...
    <h1 style="margin-top: 12px;margin-bottom:5px;text-align: center;">EN <?php echo  strtoupper($talle)?></h1>
    <form action="../controllers/agregarProducto.php" method="POST" enctype="multipart/form-data" class="formularioPerris">
