<?php
    ...
    $query = "SELECT * FROM ventas WHERE fecha='$fechaxD';";
    $total=0;   
    $prendas=0;
    $ganancia=0;
    ...
    while ($row = mysqli_fetch_assoc($res)) {
        ...
        $ganancia = $ganancia + $row['ganancia'];
        $prendas++;
    }
    ...
    <?php
                       include_once "controllers/conexion.php";
                        ...
                        while ($row = mysqli_fetch_assoc($res)) {
                            ...
                            $respuesta = mysqli_query($conexion, $query2);
                            $categoria="";
                        ...
                        <div>
                            ...
                            <div><p style="margin:0;margin-left:5%; color:green;">La ganancia fue de <?php echo $ganancia ?></p></div>
                        </div>
