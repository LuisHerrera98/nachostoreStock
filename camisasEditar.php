...
<body>
    ...
    <h1 style="margin-top: 12px;margin-bottom:5px;text-align: center;">EDITAR CAMISA</h1>
    <form action="camisasGuardar.php" method="POST" enctype="multipart/form-data" class="formularioPerris">
