...
<body>
    ...
    <h1 style="margin-top: 12px;margin-bottom:5px;text-align: center;">EDITAR JEAN</h1>
    <form action="jeansGuardar.php" method="POST" enctype="multipart/form-data" class="formularioPerris">
