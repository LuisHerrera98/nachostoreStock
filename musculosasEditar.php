...
<body>
    ...
    <h1 style="margin-top: 12px;margin-bottom:5px;text-align: center;">EDITAR MUSCULOSA</h1>
    <form action="musculosasGuardar.php" method="POST" enctype="multipart/form-data" class="formularioPerris">
