...
<body>
    ...
    $query = "SELECT id,nombre,precio,tipo,imagen,cantidad,ganancia FROM buzos WHERE talle='$talle' order by id desc;";
    $res = mysqli_query($con, $query);
    while ($row = mysqli_fetch_assoc($res)) {
    ?>
       <article class="caja-producto">
       <a href="producto.php?id=<?php echo $row['id']?>&categoria=buzos">
            <div class="figure">  
