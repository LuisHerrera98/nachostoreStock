...
<body>
    ...
    <section>
        <h2 class="productosDestacados" style="margin:0; text-align:center;margin-top:12px; margin-bottom:12px;">Camisas talle <?php echo $talle ?></h2>
    <div style="width:100%; display:flex; justify-content:center">
        <a href="camisasAgregar.php?talle=<?php echo $talle ?>"><button class="boton-agregar">Agregar</button></a>
    </div>
    <div class="caja-productos">
    <?php
    // include_once "db_empresa.php";
    $con = mysqli_connect("localhost", "root","","nachostore_stock");
    $query = "SELECT id,nombre,precio,tipo,imagen,cantidad,ganancia FROM camisas WHERE talle='$talle';";
       ...
       <article class="caja-producto">
          <div class="figure">  
             ...
             <div style="position:absolute; border-radius:50px;color:white;background-color:black; top:2px;right:3px;margin:0; font-size:14px;width:26px;height:26px; display:flex; justify-content:center; align-items:center;"><p style="margin:0; text-align:center; font-family:Arial, Helvetica, sans-serif;">
                <form action="camisasAumentar.php" method="post">
                ...
                <div style="display:flex; justify-content:space-around; width:100%;">
                    <form action="camisasBorrar.php" method="post" style="width:45%;" enctype="multipart/form-data">
                        ...
                        <input type="text" value="camisas" name="categoria" style="display:none;">
                    ...
                    <form action="camisasEditar.php" method="post" style="width:45%;">
