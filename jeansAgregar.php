    ...
    $ganancia = $_POST['precio'] - $_POST['costo'];
                ...
                if (isset($_REQUEST['guardar'])) {
                    if (isset($_FILES['foto']['name'])) {
                        ...
                        $query = "INSERT INTO jeans (nombre  ,precio            ,imagen                 ,tipo,cantidad,talle,ganancia) values 
                                                         ('" . $_POST['nombre'] . "','" . $_POST['precio'] . "','" . $binariosImagen . "','" . $tipoArchivo . "','" . $_POST['cantidad'] . "','" . $_POST['talle'] . "','" . $ganancia . "');
                            ";
                        $res = mysqli_query($con, $query);
                        header("Location:jeansLista.php?talle=" . $talle);
                    }
                }
                ?>
    <h1 style="margin-top: 12px;margin-bottom:5px;text-align: center;">AGREGAR JEAN</h1>
