...
<body>
    ...
    <section>
    <h2 class="productosDestacados" style="margin:0; text-align:center;margin-top:12px; margin-bottom:12px ;font-size:18px;">JOGGINS</h2>
        ...
        <div class="caja-talles">
            <div class="caja-talle">
                <a href="jogginsLista.php?talle=S" style="color:#333;" type="submit"><i class="fas fa-folder icono-carpeta"><p class="texto-talle">TALLE S</p></i></a>
            </div>
            <div class="caja-talle">
                <a href="jogginsLista.php?talle=M"style="color:#333;" type="submit"><i class="fas fa-folder icono-carpeta"><p class="texto-talle M">TALLE M</p></i></a>
            </div>
            <div class="caja-talle">
                <a href="jogginsLista.php?talle=L"style="color:#333;" type="submit"><i class="fas fa-folder icono-carpeta"><p class="texto-talle L">TALLE L</p></i></a>
            </div>
            <div class="caja-talle">
                <a href="jogginsLista.php?talle=XL"style="color:#333;" type="submit"><i class="fas fa-folder icono-carpeta"><p class="texto-talle XL">TALLE XL</p></i></a>
            </div>
            <div class="caja-talle">
                <a href="jogginsLista.php?talle=XXL"style="color:#333;" type="submit"><i class="fas fa-folder icono-carpeta"><p class="texto-talle XXL">TALLE XXL</p></i></a>
            </div>
            <div class="caja-talle">
                <a href="jogginsLista.php?talle=XXXL"style="color:#333;" type="submit"><i class="fas fa-folder icono-carpeta"><p class="texto-talle XXXL">TALLE XXXL</p></i></a>   
            </div>
        </div>
    </section>
    <footer>
