    ...
    $ganancia = $_POST['precio'] - $_POST['costo'];
                ...
                if (isset($_REQUEST['guardar'])) {
                    if (isset($_FILES['foto']['name'])) {
                        ...
                        $query = "INSERT INTO parkas (nombre  ,precio            ,imagen                 ,tipo,cantidad,talle,ganancia) values 
                ...
                ?>
    <h1 style="margin-top: 12px;margin-bottom:5px;text-align: center;">AGREGAR PARKA</h1>
