...
<body>
    ...
    <section>
        <h2 class="productosDestacados" style="margin:0; text-align:center;margin-top:12px; margin-bottom:12px;">Camperas Talle <?php echo $talle ?></h2>
    <div style="width:100%; display:flex; justify-content:center">
        <a href="camperasAgregar.php?talle=<?php echo $talle ?>"><button class="boton-agregar">Agregar</button></a>
    </div>
    ...
    $query = "SELECT id,nombre,precio,tipo,imagen,cantidad,ganancia FROM camperas WHERE talle='$talle';";
       ...
       <article class="caja-producto">
          <div class="figure">  
             ...
             <div style="position:absolute; border-radius:50px;color:white;background-color:black; top:2px;right:3px;margin:0; font-size:14px;width:26px;height:26px; display:flex; justify-content:center; align-items:center;"><p style="margin:0; text-align:center; font-family:Arial, Helvetica, sans-serif;">
                <form action="camperasAumentar.php" method="post">
                ...
                <div style="display:flex; justify-content:space-around; width:100%;">
                    <form action="camperasBorrar.php" method="post" style="width:45%;" enctype="multipart/form-data">
                        ...
                        <input type="text" value="camperas" name="categoria" style="display:none;">
                    ...
                    <form action="camperasEditar.php" method="post" style="width:45%;">
