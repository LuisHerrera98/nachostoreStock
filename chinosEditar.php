...
<head>
    ...
    <title>Editar chinos/vestir</title>
...
<body>
    ...
    <h1 style="margin-top: 12px;margin-bottom:5px;text-align: center;">EDITAR CHINO/VESTIR</h1>
    <form action="chinosGuardar.php" method="POST" enctype="multipart/form-data" class="formularioPerris">

        <input type="hidden" name="id" id="id" class="input-crear" value="<?php echo $id ?>">
        <input type="hidden" name="talle" id="id" class="input-crear" value="<?php echo $talle ?>">
