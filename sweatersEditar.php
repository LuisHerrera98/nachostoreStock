...
<body>
    ...
    <h1 style="margin-top: 12px;margin-bottom:5px;text-align: center;">EDITAR SWEATER</h1>
    <form action="sweatersGuardar.php" method="POST" enctype="multipart/form-data" class="formularioPerris">
