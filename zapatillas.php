...
<body>
    ...
    <section>
    <h2 class="productosDestacados" style="margin:0; text-align:center;margin-top:12px; margin-bottom:12px ;font-size:18px;">ZAPATILLAS</h2>
        ...
        <div class="caja-talles">
            <div class="caja-talle">
                <a href="zapatillasLista.php?talle=37" style="color:#333;" type="submit"><i class="fas fa-folder icono-carpeta"><p class="texto-talle">TALLE 37</p></i></a>
            </div>
            <div class="caja-talle">
                <a href="zapatillasLista.php?talle=38" style="color:#333;" type="submit"><i class="fas fa-folder icono-carpeta"><p class="texto-talle">TALLE 38</p></i></a>
            </div>
            <div class="caja-talle">
                <a href="zapatillasLista.php?talle=39"style="color:#333;" type="submit"><i class="fas fa-folder icono-carpeta"><p class="texto-talle M">TALLE 39</p></i></a>
            </div>
            <div class="caja-talle">
                <a href="zapatillasLista.php?talle=40"style="color:#333;" type="submit"><i class="fas fa-folder icono-carpeta"><p class="texto-talle L">TALLE 40</p></i></a>
            </div>
            <div class="caja-talle">
                <a href="zapatillasLista.php?talle=41"style="color:#333;" type="submit"><i class="fas fa-folder icono-carpeta"><p class="texto-talle XL">TALLE 41</p></i></a>
            </div>
            <div class="caja-talle">
                <a href="zapatillasLista.php?talle=42"style="color:#333;" type="submit"><i class="fas fa-folder icono-carpeta"><p class="texto-talle XXL">TALLE 42</p></i></a>
            </div>
            <div class="caja-talle">
                <a href="zapatillasLista.php?talle=43"style="color:#333;" type="submit"><i class="fas fa-folder icono-carpeta"><p class="texto-talle XXXL">TALLE 43</p></i></a>   
            </div>
            <div class="caja-talle">
                <a href="zapatillasLista.php?talle=44"style="color:#333;" type="submit"><i class="fas fa-folder icono-carpeta"><p class="texto-talle XXXL">TALLE 44</p></i></a>   
            </div>
            <div class="caja-talle">
                <a href="zapatillasLista.php?talle=45"style="color:#333;" type="submit"><i class="fas fa-folder icono-carpeta"><p class="texto-talle XXXL">TALLE 45</p></i></a>   
            </div>
        </div>
    </section>
    <footer>
