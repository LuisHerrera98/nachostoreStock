...
<body>
    ...
    <h1 style="margin-top: 12px;margin-bottom:5px;text-align: center;">EDITAR ZAPATILLA</h1>
    <form action="zapatillasGuardar.php" method="POST" enctype="multipart/form-data" class="formularioPerris">
